...
import {styles} from '../converter/styles'
...
export default class Conversor extends Component{
    constructor(props) {
        ...
        this.state = {
            ...
            moedaB: 0,
            moedas:[
                {id: 1, nome: 'Dólar', cifra: ' US$', sigla: 'USD'},
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.areaPicker}>
                    ...
                    onValueChange={(itemValue) => this.setState({moedaA: itemValue})} 
                    >
                        {moedasItem}
                    </Picker>
                    ...
                    onValueChange={(itemValue) => this.setState({moedaB: itemValue})} 
                    >
                        {moedasItem}
                    </Picker>
                </View>
